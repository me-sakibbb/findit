          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="bg-card rounded-lg p-6">
                <h3 className="font-semibold text-lg mb-2">How do I post an item?</h3>
                <p className="text-muted-foreground">
                  Click the "Report an Item" button and fill out the form with as much detail as possible.
                </p>
              </div>
              <div className="bg-card rounded-lg p-6">
                <h3 className="font-semibold text-lg mb-2">Is my personal information safe?</h3>
                <p className="text-muted-foreground">
                  Yes, we prioritize your privacy. Your contact information is never shared publicly.
                </p>
              </div>
              <div className="bg-card rounded-lg p-6">
                <h3 className="font-semibold text-lg mb-2">How does the AI matching work?</h3>
                <p className="text-muted-foreground">
                  Our AI analyzes item descriptions, categories, and locations to find the most likely matches.
                </p>
              </div>
            </div>
          </div>
